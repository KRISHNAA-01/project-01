...
//                     <div>
//                         {cartItem.map((item) => (
//   <div key={item._id} className="flex gap-[40px] justify-center pt-[50px] pb-[20px]"> {/* Use key={item._id} */}
...
//         <h2>{item.price ? `Rs. ${item.price}` : "Price not available"}</h2>
//       </div>
//       <div className="flex gap-[40px] pb-[10px]">
...
//             onClick={() => decreaseQuantity(item._id)} // Update to use item._id
//           >
//             -
//           </button>
...
//           <button
//             className="border border-[#e30217] text-[#e30217] px-[10px] rounded-[6px]"
//             onClick={() => increaseQuantity(item._id)} // Update to use item._id
//           >
//             +
//           </button>
//         </div>
...
//         <h2>{item.quantity && item.price ? `Rs. ${item.quantity * item.price}` : "Total not available"}</h2>
//       </div>
//     </div>
//     <button
//       onClick={() => removeItemFromCart(item._id)} // Update to use item._id
