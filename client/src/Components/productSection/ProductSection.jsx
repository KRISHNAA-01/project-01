...
export default function ProductSection() {
  ...
  return (
    <section id="products" className="w-full min-h-screen bg-cover bg-center bg-[url('https://wallpaperaccess.com/full/2076125.jpg')] py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center mb-6">
          <input
            type="text"
            placeholder="Search for furniture..."
            className="p-3 border border-gray-300 rounded-lg w-full max-w-md shadow-md focus:border-[#e30217] focus:outline-none"
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
          />
        </div>
